...
(function(){
    ...
    modal.innerHTML = `
      <div class="ept-panel" role="dialog" aria-modal="true">
        <header>
          ...
          <button class="ept-close" id="eptCloseBtn">Cerrar ✕</button>
        </header>
          ...
          <section class="ept-col">
            ...
            <div class="ept-step active" id="eptStep1">
              ...
              <div class="ept-actions">
                <button class="ept-btn ghost" id="eptResetAll">Borrar todo</button>
                <button class="ept-btn primary" id="eptToStep2">Modificar y continuar →</button>
              </div>
            </div>
  ...
  function showStep(step){
    ...
    // default: edit mode
    s1.classList.toggle("active", step==="s1");
    s1L.classList.toggle("active", step==="s1L");
    s2.classList.toggle("active", step==="s2");
    s2L.classList.toggle("active", step==="s2L");
  }
  ...
  function confirmReservation(){
    ...
    for(const s of state.selectedSlots){
      const key = slotKey(s.dateISO, s.start);
  ...
  function wire(){
    ...
    document.getElementById("eptGoAgenda")?.addEventListener("click", ()=>{
      showStep("s2");
    });
    ...
    document.getElementById("eptEditAgenda2")?.addEventListener("click", ()=>{
      showStep("s2");
    });
    ...
    document.getElementById("eptModDatos")?.addEventListener("click", ()=> showStep("s1"));
    document.getElementById("eptModAgenda")?.addEventListener("click", ()=> showStep("s2"));
